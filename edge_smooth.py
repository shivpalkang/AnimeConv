...
def make_edge_smooth(dataset_name, img_size) :
    check_folder(os.path.dirname(os.path.abspath(__file__))+'/dataset/{}/{}'.format(dataset_name, 'smooth'))

    file_list = glob(os.path.dirname(os.path.abspath(__file__))+'/dataset/{}/{}/*.*'.format(dataset_name, 'style'))
    save_dir = os.path.dirname(os.path.abspath(__file__))+'/dataset/{}/smooth'.format(dataset_name)
